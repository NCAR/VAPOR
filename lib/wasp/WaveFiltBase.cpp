...
void WaveFiltBase::wrev(const double *sigIn, double *sigOut, int sigLength)
    const {
    int count = 0;
 ...
 *-----------------------------------------*/
void WaveFiltBase::qmf_even(const double *sigIn, double *sigOut, int sigLength)
    const {
 ...
 *-----------------------------------------*/
void WaveFiltBase::qmf_wrev(const double *sigIn, double *sigOut, int sigLength)
    const {
...
void WaveFiltBase::verbatim_copy(const double *sigIn, double *sigOut, int sigLength)
    const {
    int count = 0;
    for (count = 0; count < sigLength; count++)
