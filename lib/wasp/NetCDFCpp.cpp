...
int NetCDFCpp::InqDims(
    vector<string> &dimnames, vector<size_t> &dims) const {
    dimnames.clear();
    dims.clear();
...
int NetCDFCpp::InqAttnames(
    string varname, std::vector<string> &attnames) const {
    attnames.clear();
...
int NetCDFCpp::CopyAtt(
    string varname_in, string attname, NetCDFCpp &ncdf_out, string varname_out) const {
...
int NetCDFCpp::PutAtt(
    string varname, string attname, int value) const {
    return (NetCDFCpp::PutAtt(varname, attname, &value, 1));
}

int NetCDFCpp::PutAtt(
    string varname, string attname, vector<int> values) const {
...
int NetCDFCpp::PutAtt(
    string varname, string attname, const int values[], size_t n) const {
...
int NetCDFCpp::GetAtt(
    string varname, string attname, int values[], size_t n) const {
    int varid;
    int rc = InqVarid(varname, varid);
    if (rc < 0)
        return (rc);
...
//
int NetCDFCpp::PutAtt(
    string varname, string attname, size_t value) const {
    return (NetCDFCpp::PutAtt(varname, attname, &value, 1));
}

int NetCDFCpp::PutAtt(
    string varname, string attname, vector<size_t> values) const {
    vector<int> ivalues;
...
int NetCDFCpp::PutAtt(
    ...
    const size_t values[], size_t n) const {
    vector<int> ivalues;
...
int NetCDFCpp::GetAtt(
    string varname, string attname, size_t values[], size_t n) const {
...
//
int NetCDFCpp::PutAtt(
    string varname, string attname, float value) const {
    return (NetCDFCpp::PutAtt(varname, attname, &value, 1));
}

int NetCDFCpp::PutAtt(
    string varname, string attname, vector<float> values) const {
    size_t n = values.size();
...
int NetCDFCpp::PutAtt(
    string varname, string attname, const float values[], size_t n) const {
...
//
int NetCDFCpp::PutAtt(
    string varname, string attname, double value) const {
    return (NetCDFCpp::PutAtt(varname, attname, &value, 1));
}
...
int NetCDFCpp::PutAtt(
    string varname, string attname, const double values[], size_t n) const {
...
int NetCDFCpp::GetAtt(
    string varname, string attname, float values[], size_t n) const {
    int varid;
    int rc = InqVarid(varname, varid);
    if (rc < 0)
        return (rc);
...
int NetCDFCpp::GetAtt(
    string varname, string attname, double values[], size_t n) const {
    int varid;
    int rc = InqVarid(varname, varid);
    if (rc < 0)
        return (rc);
...
int NetCDFCpp::PutAtt(
    string varname, string attname, string value) const {
...
int NetCDFCpp::PutAtt(
    string varname, string attname, vector<string> values) const {
    string s;
...
int NetCDFCpp::PutAtt(
    string varname, string attname, const char values[], size_t n) const {
...
int NetCDFCpp::GetAtt(
    string varname, string attname, char values[], size_t n) const {
    int varid;
    int rc = InqVarid(varname, varid);
    if (rc < 0)
        return (rc);
...
int NetCDFCpp::InqVarid(
    string varname, int &varid) const {
...
int NetCDFCpp::InqAtt(
    string varname, string attname, nc_type &xtype, size_t &len) const {
...
int NetCDFCpp::_PutVara(
    ...
    if (func == "nc_put_vara") {
        ...
        rc = nc_put_vara_float(
            _ncid, varid, mystart, mycount, (const float *)data);
    } else if (func == "nc_put_vara_double") {
        rc = nc_put_vara_double(
            _ncid, varid, mystart, mycount, (const double *)data);
    } else if (func == "nc_put_vara_int") {
        rc = nc_put_vara_int(_ncid, varid, mystart, mycount, (const int *)data);
    } else if (func == "nc_put_vara_long") {
        rc = nc_put_vara_long(
            _ncid, varid, mystart, mycount, (const long *)data);
...
int NetCDFCpp::PutVara(
    ...
    return (_PutVara(
        varname, start, count, (const void *)data, "nc_put_vara_float"));
}
...
int NetCDFCpp::PutVara(
    ...
    return (_PutVara(
        varname, start, count, (const void *)data, "nc_put_vara_double"));
}
...
int NetCDFCpp::PutVara(
    ...
    return (_PutVara(
        varname, start, count, (const void *)data, "nc_put_vara_int"));
}
...
int NetCDFCpp::PutVara(
    ...
    return (_PutVara(
        varname, start, count, (const void *)data, "nc_put_vara_long"));
}
...
int NetCDFCpp::PutVara(
    ...
    return (_PutVara(
        varname, start, count, (const void *)data, "nc_put_vara_uchar"));
}
...
int NetCDFCpp::GetVara(
    string varname,
    vector<size_t> start, vector<size_t> count, void *data) const {
    return (_GetVara(varname, start, count, (void *)data, "nc_get_vara"));
}

int NetCDFCpp::GetVara(
    string varname,
    vector<size_t> start, vector<size_t> count, float *data) const {
    return (_GetVara(varname, start, count, (void *)data, "nc_get_vara_float"));
}

int NetCDFCpp::GetVara(
    string varname,
    vector<size_t> start, vector<size_t> count, double *data) const {
    return (_GetVara(varname, start, count, (void *)data, "nc_get_vara_double"));
}

int NetCDFCpp::GetVara(
    string varname,
    vector<size_t> start, vector<size_t> count, int *data) const {
    return (_GetVara(varname, start, count, (void *)data, "nc_get_vara_int"));
}

int NetCDFCpp::GetVara(
    string varname,
    vector<size_t> start, vector<size_t> count, long *data) const {
    return (_GetVara(varname, start, count, (void *)data, "nc_get_vara_long"));
}

int NetCDFCpp::GetVara(
    string varname,
    vector<size_t> start, vector<size_t> count, unsigned char *data) const {
