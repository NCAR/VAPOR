...
MatWaveWavedec::MatWaveWavedec(
    const string &wname,
    const string &mode) : MatWaveDwt(wname, mode) {
}

MatWaveWavedec::MatWaveWavedec(
    const string &wname) : MatWaveDwt(wname) {
}
...
void MatWaveWavedec::computeL(
    size_t sigInLen, int n, size_t *L) const {
    L[n + 1] = sigInLen;
    L[n] = sigInLen;
    for (int i = n; i > 0; i--) {
...
void MatWaveWavedec::computeL2(
    size_t sigInX, size_t sigInY, int n, size_t *L) const {
    L[(n * 6) + 4 - 4] = sigInX;
    L[(n * 6) + 4 - 3] = sigInY;
    L[(n * 6) + 4 - 2] = sigInX;
    L[(n * 6) + 4 - 1] = sigInY;
...
void MatWaveWavedec::computeL3(
    size_t sigInX, size_t sigInY, size_t sigInZ, int n, size_t *L) const {
...
void MatWaveWavedec::approxlength(
    const size_t *L, int n, int l, size_t *len) const {
    if (l > n)
        l = n;
...
void MatWaveWavedec::approxlength2(
    const size_t *L, int n, int l, size_t *lenx, size_t *leny) const {
    if (l > n)
        l = n;
...
void MatWaveWavedec::approxlength3(
    const size_t *L, int n, int l, size_t *lenx, size_t *leny, size_t *lenz) const {
    if (l > n)
        l = n;
...
size_t MatWaveWavedec::coefflength2(
    size_t sigInX, size_t sigInY, int n) const {
...
size_t MatWaveWavedec::coefflength3(
    size_t sigInX, size_t sigInY, size_t sigInZ, int n) const {
