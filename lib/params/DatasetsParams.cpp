...
DatasetsParams::DatasetsParams(
    ParamsBase::StateSave *ssave) : ParamsBase(ssave, DatasetsParams::GetClassType()) {
...
DatasetsParams::DatasetsParams(const DatasetsParams &rhs)
    : ParamsBase(rhs) {
...
DatasetParams::DatasetParams(
    ParamsBase::StateSave *ssave) : ParamsBase(ssave, DatasetParams::GetClassType()) {
...
DatasetParams::DatasetParams(const DatasetParams &rhs)
    : ParamsBase(rhs) {
