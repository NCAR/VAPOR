...
// Constructor
//----------------------------------------------------------------------------
Transform::Transform(ParamsBase::StateSave *ssave) : ParamsBase(ssave, Transform::GetClassType()) { _init(); }

Transform::Transform(ParamsBase::StateSave *ssave, XmlNode *node) : ParamsBase(ssave, node) { _init(); }
