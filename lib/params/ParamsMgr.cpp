...
void ParamsMgr::RemoveVisualizer(string winName) {
    ...
    if (!windowsSep.HasChild(winName))
        return;
...
void ParamsMgr::GetRenderParamNames(
    string winName, string dataSetName, vector<string> &instNames) const {
    instNames.clear();
...
void ParamsMgr::GetRenderParamNames(
    string winName, vector<string> &instNames) const {
    instNames.clear();
...
bool ParamsMgr::RenderParamsLookup(
    string instName, string &winName, string &dataSetName, string &className) const {
    winName.clear();
    dataSetName.clear();
    className.clear();
...
vector<string> ParamsMgr::GetRenderParamInstances(
    string winName, string dataSetName, string className) const {
