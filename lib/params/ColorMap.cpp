...
// Constructor
//----------------------------------------------------------------------------
ColorMap::Color::Color(float h, float s, float v) : _hue(h),
                                                    _sat(s),
                                                    _val(v) {
}
//----------------------------------------------------------------------------
// Constructor
//----------------------------------------------------------------------------
ColorMap::Color::Color(double h, double s, double v) : _hue((float)h),
                                                       _sat((float)s),
                                                       _val((float)v) {
}
...
// Copy Constructor
//----------------------------------------------------------------------------
ColorMap::Color::Color(const Color &c) : _hue(c._hue),
                                         _sat(c._sat),
                                         _val(c._val) {
}
...
ColorMap::ColorMap(
    ParamsBase::StateSave *ssave) : ParamsBase(ssave, ColorMap::GetClassType()) {
