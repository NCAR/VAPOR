...
ParamsSeparator::ParamsSeparator(
    StateSave *ssave, const string &name) : ParamsBase(ssave, name) {
}

ParamsSeparator::ParamsSeparator(
    StateSave *ssave, XmlNode *node) : ParamsBase(ssave, node) {
}

ParamsSeparator::ParamsSeparator(
    ParamsSeparator *parent, const string &name) : ParamsBase(parent->_ssave) {
