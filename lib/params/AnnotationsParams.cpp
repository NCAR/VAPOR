...
AnnotationsParams::AnnotationsParams(ParamsBase::StateSave *ssave) : ParamsBase(ssave, AnnotationsParams::GetClassType())
{
    _init();
...
AnnotationsParams::AnnotationsParams(ParamsBase::StateSave *ssave, XmlNode *node) : ParamsBase(ssave, node)
{
...
AnnotationsParams::AnnotationsParams(const AnnotationsParams &rhs) : ParamsBase(rhs) { _axisAnnotations = new ParamsContainer(*(rhs._axisAnnotations)); }
...
void AnnotationsParams::GetDomainColor(double color[3]) const { m_getColor(color, _domainColorTag); }

void AnnotationsParams::SetDomainColor(vector<double> color) { m_setColor(color, _domainColorTag, "Set domain frame color"); }

void AnnotationsParams::GetRegionColor(double color[3]) const { m_getColor(color, _regionColorTag); }

void AnnotationsParams::SetRegionColor(vector<double> color) { m_setColor(color, _regionColorTag, "Set region frame color"); }

void AnnotationsParams::GetBackgroundColor(double color[3]) const { m_getColor(color, _backgroundColorTag); }

void AnnotationsParams::SetBackgroundColor(vector<double> color) { m_setColor(color, _backgroundColorTag, "Set background color"); }
...
string AnnotationsParams::GetCurrentAxisDataMgrName() const { return GetValueString(_currentAxisDataMgrTag, ""); }
...
void AnnotationsParams::SetShowAxisArrows(bool val) { SetValueLong(_showAxisArrowsTag, "Toggle Axis Arrows", val); }

bool AnnotationsParams::GetShowAxisArrows() const { return (0 != GetValueLong(_showAxisArrowsTag, (long)false)); }
