...
int NetCDFSimple::Read(
    const size_t start[], const size_t count[], float *data, int fd) const {
...
int NetCDFSimple::Read(
    const size_t start[], const size_t count[], int *data, int fd) const {
...
int NetCDFSimple::Read(
    const size_t start[], const size_t count[], char *data, int fd) const {
...
void NetCDFSimple::GetDimensions(
    vector<string> &names, vector<size_t> &dims) const {
    names = _dimnames;
    dims = _dims;
}
