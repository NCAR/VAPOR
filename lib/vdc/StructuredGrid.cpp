...
StructuredGrid::ConstNodeIteratorSG::ConstNodeIteratorSG(
    ...
    const std::vector<double> &minu, const std::vector<double> &maxu) : ConstNodeIteratorAbstract() {
...
StructuredGrid::ConstCellIteratorSG::ConstCellIteratorSG(
    const StructuredGrid *rg,
    const std::vector<double> &minu, const std::vector<double> &maxu) : ConstCellIteratorAbstract() {
    assert(0 && "Not supported");
}
