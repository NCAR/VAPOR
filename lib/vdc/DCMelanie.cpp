...
template <class T>
bool DCMelanie::_getAttTemplate(
...
int DCMelanie::getDimLensAtLevel(
...
template <class T>
int DCMelanie::_readRegionTemplate(
	int fd,
