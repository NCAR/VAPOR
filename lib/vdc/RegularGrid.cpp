...
RegularGrid::RegularGrid(
    ...
    const vector<double> &minu,
    const vector<double> &maxu) : StructuredGrid(dims, bs, blks) {
...
RegularGrid::ConstCoordItrRG::ConstCoordItrRG(
    const RegularGrid *rg, bool begin) : ConstCoordItrAbstract() {
...
RegularGrid::ConstCoordItrRG::ConstCoordItrRG(
    const ConstCoordItrRG &rhs) : ConstCoordItrAbstract() {
    _index = rhs._index;
    _dims = rhs._dims;
    _minu = rhs._minu;
    _delta = rhs._delta;
