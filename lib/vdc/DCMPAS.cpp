...
int DCMPAS::_get_latlon_coordvars(NetCDFMPASCollection *ncdfc, string dvar, string &loncvar, string &latcvar) const
{
    loncvar.clear();
    latcvar.clear();
...
int DCMPAS::_get_latlon_extents(NetCDFMPASCollection *ncdfc, string latlon, bool lonflag, float &min, float &max)
{
...
int DCMPAS::_get_coord_pair_extents(NetCDFMPASCollection *ncdfc, string lon, string lat, double &lonmin, double &lonmax, double &latmin, double &latmax)
{
...
int DCMPAS::_InitHorizontalCoordinatesDerived(NetCDFMPASCollection *ncdfc, const vector<pair<string, string>> &coordpairs)
{
...
int DCMPAS::_InitVerticalCoordinatesDerived(NetCDFMPASCollection *ncdfc, const vector<string> &cvars)
{
    vector<bool> periodic(3, false);
    for (int i = 0; i < cvars.size(); i++) {
...
// is significant.
//
int DCMPAS::_GetVarCoordinates(NetCDFMPASCollection *ncdfc, string varname, vector<string> &sdimnames, vector<string> &scoordvars, string &time_dim_name, string &time_coordvar)
{
    sdimnames.clear();
    scoordvars.clear();
    time_dim_name.clear();
...
//
DCMPAS::DerivedVarHorizontal::DerivedVarHorizontal(NetCDFMPASCollection *ncdfc, string lonname, string latname, const vector<DC::Dimension> &dims, Proj4API *proj4API, bool xflag) : DerivedVar(ncdfc)
{
