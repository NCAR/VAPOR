...
UnstructuredGrid::UnstructuredGrid(size_t topology_dimension, const std::vector<size_t> &node_dims, const std::vector<size_t> &cell_dims, const std::vector<size_t> &edge_dims,
                                   const std::vector<float *> &blks, const size_t *face_node_conn, const size_t *face_face_conn,
...
float *UnstructuredGrid::_AccessIndex(const std::vector<float *> &blks, const std::vector<size_t> &indices) const
{
...
template<class T> UnstructuredGrid::ForwardIterator<T>::ForwardIterator(T *rg, const vector<double> &minu, const vector<double> &maxu) : _pred(minu, maxu)
{
    if (!rg->GetBlks().size()) {
        _end = true;
        return;
...
#ifdef DEAD
template<class T> UnstructuredGrid::ForwardIterator<T>::ForwardIterator(const ForwardIterator<T> &rhs)
{
    _rg = rhs._rg;
...
template<class T> UnstructuredGrid::ForwardIterator<T> &UnstructuredGrid::ForwardIterator<T>::operator=(ForwardIterator<T> rhs)
{
    swap(*this, rhs);
    return (*this);
}

template<class T> UnstructuredGrid::ForwardIterator<T> &UnstructuredGrid::ForwardIterator<T>::operator++()
{
...
#ifdef DEAD
template<class T> UnstructuredGrid::ForwardIterator<T> UnstructuredGrid::ForwardIterator<T>::operator++(int)
{
    if (_end) return (*this);
...
template<class T> UnstructuredGrid::ForwardIterator<T> &UnstructuredGrid::ForwardIterator<T>::operator+=(const long int &offset)
{
    _end = false;
...
template<class T> UnstructuredGrid::ForwardIterator<T> UnstructuredGrid::ForwardIterator<T>::operator+(const long int &offset) const
{
    ForwardIterator temp(*this);
...
template<class T> bool UnstructuredGrid::ForwardIterator<T>::operator!=(const UnstructuredGrid::ForwardIterator<T> &other)
{
...
//
//
template<class T> UnstructuredGrid::CellIterator<T>::CellIterator(T *sg, const vector<double> &minu, const vector<double> &maxu) : _pred(minu, maxu)
{
    _sg = sg;
...
template<class T> UnstructuredGrid::ForwardCellIterator<T>::ForwardCellIterator(T *sg, bool begin)
{
    _sg = sg;
...
template<class T> UnstructuredGrid::ForwardCellIterator<T>::ForwardCellIterator(ForwardCellIterator<T> &&rhs)
{
    _sg = rhs._sg;
    rhs._sg = nullptr;
    _dims = rhs._dims;
...
template<class T> UnstructuredGrid::ForwardCellIterator<T> &UnstructuredGrid::ForwardCellIterator<T>::operator=(ForwardCellIterator<T> rhs)
{
    swap(*this, rhs);
    return (*this);
}

template<class T> UnstructuredGrid::ForwardCellIterator<T> &UnstructuredGrid::ForwardCellIterator<T>::next2d()
{
...
template<class T> UnstructuredGrid::ForwardCellIterator<T> &UnstructuredGrid::ForwardCellIterator<T>::next3d()
{
...
template<class T> UnstructuredGrid::ForwardCellIterator<T> &UnstructuredGrid::ForwardCellIterator<T>::operator++()
{
...
//
//
template<class T> UnstructuredGrid::NodeIterator<T>::NodeIterator(T *sg, const vector<double> &minu, const vector<double> &maxu) : _pred(minu, maxu)
{
    _sg = sg;
    _dims = rg->GetDimensions();
...
template<class T> UnstructuredGrid::ForwardNodeIterator<T>::ForwardNodeIterator(T *sg, bool begin)
{
    _sg = sg;
    _dims = sg->GetDimensions();
...
template<class T> UnstructuredGrid::ForwardNodeIterator<T>::ForwardNodeIterator(ForwardNodeIterator<T> &&rhs)
{
    _sg = rhs._sg;
    rhs._sg = nullptr;
    _dims = rhs._dims;
...
template<class T> UnstructuredGrid::ForwardNodeIterator<T> &UnstructuredGrid::ForwardNodeIterator<T>::operator=(ForwardNodeIterator<T> rhs)
{
    swap(*this, rhs);
    return (*this);
}

template<class T> UnstructuredGrid::ForwardNodeIterator<T> &UnstructuredGrid::ForwardNodeIterator<T>::next2d()
{
...
template<class T> UnstructuredGrid::ForwardNodeIterator<T> &UnstructuredGrid::ForwardNodeIterator<T>::next3d()
{
...
template<class T> UnstructuredGrid::ForwardNodeIterator<T> &UnstructuredGrid::ForwardNodeIterator<T>::operator++()
{
    if (_dims.size() == 2) return (next2d());
    if (_dims.size() == 3) return (next3d());
