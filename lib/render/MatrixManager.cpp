...
mat4 MatrixManager::GetModelViewProjectionMatrix() { return GetProjectionMatrix() * GetModelViewMatrix(); }
...
void MatrixManager::Perspective(float fovy, float aspect, float zNear, float zFar) { top() = glm::perspective(fovy, aspect, zNear, zFar); }
