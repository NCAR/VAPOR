...
VolumeOSPRay::WindingOrder VolumeOSPRay::getWindingOrderRespectToZ(const vec3 &a, const vec3 &b, const vec3 &c)
{
...
const char *VolumeOSPRay::windingOrderToString(WindingOrder o)
{
