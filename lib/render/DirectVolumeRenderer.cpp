...
bool DirectVolumeRenderer::UserCoordinates::Fill( const DVRParams* params,
                                                        DataMgr*   dataMgr )
{
    ...
    VAPoR::StructuredGrid* grid = dynamic_cast<VAPoR::StructuredGrid*>(
           dataMgr->GetVariable(  params->GetCurrentTimestep(),
...
int DirectVolumeRenderer::_paintGL() 
{
    ...
    _drawVolumeFaces( _userCoordinates.frontFace,
                      _userCoordinates.backFace,
                      _userCoordinates.rightFace,
                      _userCoordinates.leftFace,
                      _userCoordinates.topFace,
                      _userCoordinates.bottomFace,
                      _userCoordinates.boxMin,
                      _userCoordinates.boxMax,
                      _userCoordinates.dims,
                      1 );  // The 1st pass!!!
...
void DirectVolumeRenderer::_drawVolumeFaces( const float* frontFace,
