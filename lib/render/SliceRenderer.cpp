...
//    glColor3f(0.f, 1.f, 0.f);
    ...
    glTexCoord2f(1.0f, 0.0f); glVertex3f(max[X], min[Y], min[Z]);
    glTexCoord2f(1.0f, 1.0f); glVertex3f(max[X], max[Y], min[Z]);

    glTexCoord2f(0.0f, 0.0f); glVertex3f(min[X], min[Y], min[Z]);
    glTexCoord2f(1.0f, 1.0f); glVertex3f(max[X], max[Y], min[Z]);
    glTexCoord2f(0.0f, 1.0f); glVertex3f(min[X], max[Y], min[Z]);
