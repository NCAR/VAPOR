...
int TextObject::Initialize(string inFont, string inText, int inSize, double inCoords[3], TypeFlag inType,
                           // int inType,
...
int TextObject::drawMe(double coords[3])
{
    ...
    if (_typeFlag & LABEL) drawLabel();
    if (_typeFlag & BILLBOARD) drawBillboard();
