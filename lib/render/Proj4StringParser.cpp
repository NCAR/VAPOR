...
{
    if (0);
    else if (proj == "NWL9D")     return Ellipse_NWL_9D;
    else if (proj == "WGS84")     return Ellipse_WGS_84;
    else if (proj == "airy")      return Ellipse_Airy_1830;
    else if (proj == "bess_nam")  return Ellipse_Bessel_Namibia;
    else if (proj == "bessel")    return Ellipse_Bessel_1841;
    else if (proj == "clrk66")    return Ellipse_Clarke_1866;
    else if (proj == "clrk80")    return Ellipse_Clarke_1880;
    else if (proj == "clrk80ign") return Ellipse_Clarke_1880_IGN;
    else if (proj == "helmert")   return Ellipse_Helmert_1906;
    else if (proj == "krass")     return Ellipse_Krassowsky_1940;
    else if (proj == "plessis")   return Ellipse_Plessis_1817;
    else if (proj == "sphere")    return Ellipse_Sphere;
