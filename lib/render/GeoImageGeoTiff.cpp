...
bool GeoImageGeoTiff::_getTiffTime(
    TIFF *tif, UDUnits *udunits, double &tifftime) const {
    tifftime = 0.0;
...
int GeoImageGeoTiff::_getGTIFInfo(
    ...
    double pcsExtents[4], double geoCorners[8], string &proj4String) const {
...
bool GeoImageGeoTiff::_extractSubtexture(
    ...
    double subPCSExtentsImg[4], double subGeoCornersImg[8]) const {
