...
//
	...
	if (numTics[0] > 1 && ticLength[0] > 0.f){
		...
		if (ticDir[0] == 1) ticVec[1] = ticLength[0]; 
		else ticVec[2] = ticLength[0];
	...
	if (numTics[1] > 1 && ticLength[1] > 0.f){
		...
		pointOnAxis[2] = origin[2];
		ticVec[0] = 0.f; ticVec[1] = 0.f; ticVec[2] = 0.f;
		if (ticDir[1] == 0) ticVec[0] = ticLength[1]; 
		else ticVec[2] = ticLength[1];
	...
	if (numTics[2] > 1 && ticLength[2] > 0.f){
		...
		pointOnAxis[1] = origin[1];
		ticVec[0] = 0.f; ticVec[1] = 0.f; ticVec[2] = 0.f;
		if (ticDir[2] == 0) ticVec[0] = ticLength[2]; 
		else ticVec[1] = ticLength[2];
