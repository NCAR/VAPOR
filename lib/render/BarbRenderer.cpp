...
void BarbRenderer::renderScottsGrid(int rakeGrid[3], double rakeExts[6], vector<Grid *> variableData, int timestep, float length, float rad, const BarbParams *bParams)
{
    assert(variableData.size() == 5);
