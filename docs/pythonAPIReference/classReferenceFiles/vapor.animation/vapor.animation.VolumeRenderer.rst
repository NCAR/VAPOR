.. _vapor.animation.VolumeRenderer:


vapor.animation.VolumeRenderer
------------------------------


Help on class VolumeRenderer in vapor.animation:

vapor.animation.VolumeRenderer = class VolumeRenderer(Renderer)
 |  vapor.animation.VolumeRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
