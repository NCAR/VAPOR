.. _vapor.animation.ColorbarAnnotation:


vapor.animation.ColorbarAnnotation
----------------------------------


Help on class ColorbarAnnotation in vapor.animation:

vapor.animation.ColorbarAnnotation = class ColorbarAnnotation(vapor.params.ParamsWrapper)
 |  vapor.animation.ColorbarAnnotation(p: cppyy.gbl.VAPoR.ParamsBase)
 |  
