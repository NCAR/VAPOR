.. _vapor.animation.FuncWrapperStrList:


vapor.animation.FuncWrapperStrList
----------------------------------


Help on class FuncWrapperStrList in vapor.animation:

vapor.animation.FuncWrapperStrList = class FuncWrapperStrList(FuncWrapper)
 |  vapor.animation.FuncWrapperStrList(slist: str)
 |  
