.. _vapor.animation.ContourRenderer:


vapor.animation.ContourRenderer
-------------------------------


Help on class ContourRenderer in vapor.animation:

vapor.animation.ContourRenderer = class ContourRenderer(Renderer)
 |  vapor.animation.ContourRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
 |  Wraps VAPoR::ContourParams
