.. _vapor.animation.TwoDDataRenderer:


vapor.animation.TwoDDataRenderer
--------------------------------


Help on class TwoDDataRenderer in vapor.animation:

vapor.animation.TwoDDataRenderer = class TwoDDataRenderer(Renderer)
 |  vapor.animation.TwoDDataRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
