.. _vapor.animation.ParamsTagWrapperDouble:


vapor.animation.ParamsTagWrapperDouble
--------------------------------------


Help on class ParamsTagWrapperDouble in vapor.animation:

vapor.animation.ParamsTagWrapperDouble = class ParamsTagWrapperDouble(ParamsTagWrapper)
 |  vapor.animation.ParamsTagWrapperDouble(tag: str)
 |  
