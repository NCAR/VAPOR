.. _vapor.animation.ParamsTagWrapper:


vapor.animation.ParamsTagWrapper
--------------------------------


Help on class ParamsTagWrapper in vapor.animation:

vapor.animation.ParamsTagWrapper = class ParamsTagWrapper(vapor.smartwrapper.FuncWrapper)
 |  vapor.animation.ParamsTagWrapper(tag: str)
 |  
