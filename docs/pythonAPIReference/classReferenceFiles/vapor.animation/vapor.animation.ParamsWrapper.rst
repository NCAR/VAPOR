.. _vapor.animation.ParamsWrapper:


vapor.animation.ParamsWrapper
-----------------------------


Help on class ParamsWrapper in vapor.animation:

vapor.animation.ParamsWrapper = class ParamsWrapper(vapor.smartwrapper.SmartWrapper)
 |  vapor.animation.ParamsWrapper(p: cppyy.gbl.VAPoR.ParamsBase)
 |  
