.. _vapor.animation.BarbRenderer:


vapor.animation.BarbRenderer
----------------------------


Help on class BarbRenderer in vapor.animation:

vapor.animation.BarbRenderer = class BarbRenderer(Renderer)
 |  vapor.animation.BarbRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
