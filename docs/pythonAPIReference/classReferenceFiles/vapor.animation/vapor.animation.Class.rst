.. _vapor.animation.Class:


vapor.animation.Class
---------------------


Help on class VolumeIsoRenderer in vapor.animation:

vapor.animation.Class = class VolumeIsoRenderer(VolumeRenderer)
 |  vapor.animation.Class(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
