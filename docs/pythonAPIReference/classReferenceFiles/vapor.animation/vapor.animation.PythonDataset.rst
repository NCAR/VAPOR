.. _vapor.animation.PythonDataset:


vapor.animation.PythonDataset
-----------------------------


Help on class PythonDataset in vapor.animation:

vapor.animation.PythonDataset = class PythonDataset(Dataset)
 |  vapor.animation.PythonDataset(dataMgr: cppyy.gbl.VAPoR.DataMgr, id: str, ses)
 |  
