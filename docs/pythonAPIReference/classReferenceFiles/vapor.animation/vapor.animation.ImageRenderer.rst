.. _vapor.animation.ImageRenderer:


vapor.animation.ImageRenderer
-----------------------------


Help on class ImageRenderer in vapor.animation:

vapor.animation.ImageRenderer = class ImageRenderer(Renderer)
 |  vapor.animation.ImageRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
