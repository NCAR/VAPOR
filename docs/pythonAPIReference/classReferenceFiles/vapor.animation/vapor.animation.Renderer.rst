.. _vapor.animation.Renderer:


vapor.animation.Renderer
------------------------


Help on class Renderer in vapor.animation:

vapor.animation.Renderer = class Renderer(vapor.params.ParamsWrapper)
 |  vapor.animation.Renderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
 |  Wraps VAPoR::RenderParams
