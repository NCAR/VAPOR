.. _vapor.animation.ParamsTagWrapperLong:


vapor.animation.ParamsTagWrapperLong
------------------------------------


Help on class ParamsTagWrapperLong in vapor.animation:

vapor.animation.ParamsTagWrapperLong = class ParamsTagWrapperLong(ParamsTagWrapper)
 |  vapor.animation.ParamsTagWrapperLong(tag: str)
 |  
 |  Method resolution order:
 |      ParamsTagWrapperLong
 |      ParamsTagWrapper
