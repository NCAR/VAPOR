.. _vapor.animation.WireFrameRenderer:


vapor.animation.WireFrameRenderer
---------------------------------


Help on class WireFrameRenderer in vapor.animation:

vapor.animation.WireFrameRenderer = class WireFrameRenderer(Renderer)
 |  vapor.animation.WireFrameRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
 |  Wraps VAPoR::WireFrameParams
