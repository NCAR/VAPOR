.. _vapor.animation.FuncWrapperWrapAll:


vapor.animation.FuncWrapperWrapAll
----------------------------------


Help on class FuncWrapperWrapAll in vapor.animation:

vapor.animation.FuncWrapperWrapAll = class FuncWrapperWrapAll(FuncWrapper)
