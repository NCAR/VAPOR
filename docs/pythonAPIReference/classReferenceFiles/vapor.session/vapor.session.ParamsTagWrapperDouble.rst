.. _vapor.session.ParamsTagWrapperDouble:


vapor.session.ParamsTagWrapperDouble
------------------------------------


Help on class ParamsTagWrapperDouble in vapor.session:

vapor.session.ParamsTagWrapperDouble = class ParamsTagWrapperDouble(ParamsTagWrapper)
 |  vapor.session.ParamsTagWrapperDouble(tag: str)
 |  
