.. _vapor.session.ParamsBase:


vapor.session.ParamsBase
------------------------


Help on class ParamsBase in vapor.session:

vapor.session.ParamsBase = class ParamsBase(cppyy.gbl.Wasp.MyBase)
