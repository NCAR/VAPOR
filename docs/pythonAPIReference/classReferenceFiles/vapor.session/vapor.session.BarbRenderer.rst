.. _vapor.session.BarbRenderer:


vapor.session.BarbRenderer
--------------------------


Help on class BarbRenderer in vapor.session:

vapor.session.BarbRenderer = class BarbRenderer(Renderer)
 |  vapor.session.BarbRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
