.. _vapor.session.ParamsTagWrapperLong:


vapor.session.ParamsTagWrapperLong
----------------------------------


Help on class ParamsTagWrapperLong in vapor.session:

vapor.session.ParamsTagWrapperLong = class ParamsTagWrapperLong(ParamsTagWrapper)
 |  vapor.session.ParamsTagWrapperLong(tag: str)
 |  
