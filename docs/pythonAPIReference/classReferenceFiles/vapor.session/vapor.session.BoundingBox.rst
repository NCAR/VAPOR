.. _vapor.session.BoundingBox:


vapor.session.BoundingBox
-------------------------


Help on class BoundingBox in vapor.session:

vapor.session.BoundingBox = class BoundingBox(builtins.object)
 |  vapor.session.BoundingBox(toWrap: cppyy.gbl.VAPoR.Box)
 |  
