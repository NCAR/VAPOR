.. _vapor.session.Camera:


vapor.session.Camera
--------------------


Help on class Camera in vapor.session:

vapor.session.Camera = class Camera(builtins.object)
 |  vapor.session.Camera(ce)
 |  
