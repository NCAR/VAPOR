.. _vapor.session.ParamsWrapper:


vapor.session.ParamsWrapper
---------------------------


Help on class ParamsWrapper in vapor.session:

vapor.session.ParamsWrapper = class ParamsWrapper(vapor.smartwrapper.SmartWrapper)
 |  vapor.session.ParamsWrapper(p: cppyy.gbl.VAPoR.ParamsBase)
 |  
