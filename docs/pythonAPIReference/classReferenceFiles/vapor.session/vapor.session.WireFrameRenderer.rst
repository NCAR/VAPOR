.. _vapor.session.WireFrameRenderer:


vapor.session.WireFrameRenderer
-------------------------------


Help on class WireFrameRenderer in vapor.session:

vapor.session.WireFrameRenderer = class WireFrameRenderer(Renderer)
 |  vapor.session.WireFrameRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
