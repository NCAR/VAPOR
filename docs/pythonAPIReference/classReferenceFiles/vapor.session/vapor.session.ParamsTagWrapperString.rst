.. _vapor.session.ParamsTagWrapperString:


vapor.session.ParamsTagWrapperString
------------------------------------


Help on class ParamsTagWrapperString in vapor.session:

vapor.session.ParamsTagWrapperString = class ParamsTagWrapperString(ParamsTagWrapper)
 |  vapor.session.ParamsTagWrapperString(tag: str)
 |  
