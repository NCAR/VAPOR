.. _vapor.session.ParamsTagWrapperBool:


vapor.session.ParamsTagWrapperBool
----------------------------------


Help on class ParamsTagWrapperBool in vapor.session:

vapor.session.ParamsTagWrapperBool = class ParamsTagWrapperBool(ParamsTagWrapper)
 |  vapor.session.ParamsTagWrapperBool(tag: str)
 |  
