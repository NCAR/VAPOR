.. _vapor.session.ModelRenderer:


vapor.session.ModelRenderer
---------------------------


Help on class ModelRenderer in vapor.session:

vapor.session.ModelRenderer = class ModelRenderer(Renderer)
 |  vapor.session.ModelRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
