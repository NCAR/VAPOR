.. _vapor.session.SmartWrapperMeta:


vapor.session.SmartWrapperMeta
------------------------------


Help on class SmartWrapperMeta in vapor.session:

vapor.session.SmartWrapperMeta = class SmartWrapperMeta(vapor.cppyyDoxygenWrapper.CPPYYDoxygenWrapperMeta)
 |  vapor.session.SmartWrapperMeta(clsname, bases, clsdict: dict, wrap: type = None)
 |  
