.. _vapor.session.VolumeRenderer:


vapor.session.VolumeRenderer
----------------------------


Help on class VolumeRenderer in vapor.session:

vapor.session.VolumeRenderer = class VolumeRenderer(Renderer)
 |  vapor.session.VolumeRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
