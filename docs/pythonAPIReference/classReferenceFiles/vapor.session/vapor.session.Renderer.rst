.. _vapor.session.Renderer:


vapor.session.Renderer
----------------------


Help on class Renderer in vapor.session:

vapor.session.Renderer = class Renderer(vapor.params.ParamsWrapper)
 |  vapor.session.Renderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
