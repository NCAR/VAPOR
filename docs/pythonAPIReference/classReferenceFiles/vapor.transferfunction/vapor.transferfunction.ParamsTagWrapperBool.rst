.. _vapor.transferfunction.ParamsTagWrapperBool:


vapor.transferfunction.ParamsTagWrapperBool
-------------------------------------------


Help on class ParamsTagWrapperBool in vapor.transferfunction:

vapor.transferfunction.ParamsTagWrapperBool = class ParamsTagWrapperBool(ParamsTagWrapper)
 |  vapor.transferfunction.ParamsTagWrapperBool(tag: str)
 |  
