.. _vapor.transferfunction.ParamsTagWrapper:


vapor.transferfunction.ParamsTagWrapper
---------------------------------------


Help on class ParamsTagWrapper in vapor.transferfunction:

vapor.transferfunction.ParamsTagWrapper = class ParamsTagWrapper(vapor.smartwrapper.FuncWrapper)
 |  vapor.transferfunction.ParamsTagWrapper(tag: str)
 |  
