.. _vapor.transferfunction.ParamsBase:


vapor.transferfunction.ParamsBase
---------------------------------


Help on class ParamsBase in vapor.transferfunction:

vapor.transferfunction.ParamsBase = class ParamsBase(cppyy.gbl.Wasp.MyBase)
