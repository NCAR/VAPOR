.. _vapor.transferfunction.Path:


vapor.transferfunction.Path
---------------------------


Help on class Path in vapor.transferfunction:

vapor.transferfunction.Path = class Path(PurePath)
 |  vapor.transferfunction.Path(*args, **kwargs)
 |  
