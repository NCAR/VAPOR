.. _vapor.transform.FuncWrapperWrapAll:


vapor.transform.FuncWrapperWrapAll
----------------------------------


Help on class FuncWrapperWrapAll in vapor.transform:

vapor.transform.FuncWrapperWrapAll = class FuncWrapperWrapAll(FuncWrapper)
