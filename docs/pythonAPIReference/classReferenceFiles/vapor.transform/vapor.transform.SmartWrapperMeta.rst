.. _vapor.transform.SmartWrapperMeta:


vapor.transform.SmartWrapperMeta
--------------------------------


Help on class SmartWrapperMeta in vapor.transform:

vapor.transform.SmartWrapperMeta = class SmartWrapperMeta(vapor.cppyyDoxygenWrapper.CPPYYDoxygenWrapperMeta)
 |  vapor.transform.SmartWrapperMeta(clsname, bases, clsdict: dict, wrap: type = None)
 |  
