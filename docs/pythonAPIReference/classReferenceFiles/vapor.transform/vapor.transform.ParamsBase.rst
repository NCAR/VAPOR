.. _vapor.transform.ParamsBase:


vapor.transform.ParamsBase
--------------------------


Help on class ParamsBase in vapor.transform:

vapor.transform.ParamsBase = class ParamsBase(cppyy.gbl.Wasp.MyBase)
