.. _vapor.transform.ParamsTagWrapperLong:


vapor.transform.ParamsTagWrapperLong
------------------------------------


Help on class ParamsTagWrapperLong in vapor.transform:

vapor.transform.ParamsTagWrapperLong = class ParamsTagWrapperLong(ParamsTagWrapper)
 |  vapor.transform.ParamsTagWrapperLong(tag: str)
 |  
