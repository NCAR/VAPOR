.. _vapor.transform.ParamsTagWrapperDouble:


vapor.transform.ParamsTagWrapperDouble
--------------------------------------


Help on class ParamsTagWrapperDouble in vapor.transform:

vapor.transform.ParamsTagWrapperDouble = class ParamsTagWrapperDouble(ParamsTagWrapper)
 |  vapor.transform.ParamsTagWrapperDouble(tag: str)
 |  
