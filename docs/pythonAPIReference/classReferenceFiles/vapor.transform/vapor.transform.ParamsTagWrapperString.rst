.. _vapor.transform.ParamsTagWrapperString:


vapor.transform.ParamsTagWrapperString
--------------------------------------


Help on class ParamsTagWrapperString in vapor.transform:

vapor.transform.ParamsTagWrapperString = class ParamsTagWrapperString(ParamsTagWrapper)
 |  vapor.transform.ParamsTagWrapperString(tag: str)
 |  
