.. _vapor.renderer.EnumWrapperMeta:


vapor.renderer.EnumWrapperMeta
------------------------------


Help on class EnumWrapperMeta in vapor.renderer:

vapor.renderer.EnumWrapperMeta = class EnumWrapperMeta(builtins.type)
