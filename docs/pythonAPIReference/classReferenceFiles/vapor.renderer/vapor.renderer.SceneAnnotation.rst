.. _vapor.renderer.SceneAnnotation:


vapor.renderer.SceneAnnotation
------------------------------


Help on class SceneAnnotation in vapor.renderer:

vapor.renderer.SceneAnnotation = class SceneAnnotation(vapor.params.ParamsWrapper)
 |  vapor.renderer.SceneAnnotation(p: cppyy.gbl.VAPoR.ParamsBase)
 |  
