.. _vapor.renderer.TwoDDataRenderer:


vapor.renderer.TwoDDataRenderer
-------------------------------


Help on class TwoDDataRenderer in vapor.renderer:

vapor.renderer.TwoDDataRenderer = class TwoDDataRenderer(Renderer)
 |  vapor.renderer.TwoDDataRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
