...
Help on class Renderer in vapor.renderer:

vapor.renderer.Renderer = class Renderer(vapor.params.ParamsWrapper)
 |  vapor.renderer.Renderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
