.. _vapor.renderer.VolumeIsoRenderer:


vapor.renderer.VolumeIsoRenderer
--------------------------------


Help on class VolumeIsoRenderer in vapor.renderer:

vapor.renderer.VolumeIsoRenderer = class VolumeIsoRenderer(VolumeRenderer)
 |  vapor.renderer.VolumeIsoRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
