.. _vapor.renderer.ParamsTagWrapperString:


vapor.renderer.ParamsTagWrapperString
-------------------------------------


Help on class ParamsTagWrapperString in vapor.renderer:

vapor.renderer.ParamsTagWrapperString = class ParamsTagWrapperString(ParamsTagWrapper)
 |  vapor.renderer.ParamsTagWrapperString(tag: str)
 |  
