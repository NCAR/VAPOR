.. _vapor.renderer.WireFrameRenderer:


vapor.renderer.WireFrameRenderer
--------------------------------


Help on class WireFrameRenderer in vapor.renderer:

vapor.renderer.WireFrameRenderer = class WireFrameRenderer(Renderer)
 |  vapor.renderer.WireFrameRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
