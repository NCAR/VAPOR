.. _vapor.renderer.ParamsBase:


vapor.renderer.ParamsBase
-------------------------


Help on class ParamsBase in vapor.renderer:

vapor.renderer.ParamsBase = class ParamsBase(cppyy.gbl.Wasp.MyBase)
