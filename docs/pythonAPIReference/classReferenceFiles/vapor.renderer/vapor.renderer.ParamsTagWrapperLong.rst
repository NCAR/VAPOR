.. _vapor.renderer.ParamsTagWrapperLong:


vapor.renderer.ParamsTagWrapperLong
-----------------------------------


Help on class ParamsTagWrapperLong in vapor.renderer:

vapor.renderer.ParamsTagWrapperLong = class ParamsTagWrapperLong(ParamsTagWrapper)
 |  vapor.renderer.ParamsTagWrapperLong(tag: str)
 |  
