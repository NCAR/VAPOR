.. _vapor.renderer.ContourRenderer:


vapor.renderer.ContourRenderer
------------------------------


Help on class ContourRenderer in vapor.renderer:

vapor.renderer.ContourRenderer = class ContourRenderer(Renderer)
 |  vapor.renderer.ContourRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
