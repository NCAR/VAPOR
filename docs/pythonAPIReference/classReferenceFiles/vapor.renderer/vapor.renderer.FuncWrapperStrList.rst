.. _vapor.renderer.FuncWrapperStrList:


vapor.renderer.FuncWrapperStrList
---------------------------------


Help on class FuncWrapperStrList in vapor.renderer:

vapor.renderer.FuncWrapperStrList = class FuncWrapperStrList(FuncWrapper)
 |  vapor.renderer.FuncWrapperStrList(slist: str)
 |  
