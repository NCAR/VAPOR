.. _vapor.renderer.ParamsTagWrapperDouble:


vapor.renderer.ParamsTagWrapperDouble
-------------------------------------


Help on class ParamsTagWrapperDouble in vapor.renderer:

vapor.renderer.ParamsTagWrapperDouble = class ParamsTagWrapperDouble(ParamsTagWrapper)
 |  vapor.renderer.ParamsTagWrapperDouble(tag: str)
 |  
