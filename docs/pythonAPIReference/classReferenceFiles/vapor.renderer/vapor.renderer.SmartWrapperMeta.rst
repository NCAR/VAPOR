.. _vapor.renderer.SmartWrapperMeta:


vapor.renderer.SmartWrapperMeta
-------------------------------


Help on class SmartWrapperMeta in vapor.renderer:

vapor.renderer.SmartWrapperMeta = class SmartWrapperMeta(vapor.cppyyDoxygenWrapper.CPPYYDoxygenWrapperMeta)
 |  vapor.renderer.SmartWrapperMeta(clsname, bases, clsdict: dict, wrap: type = None)
 |  
