.. _vapor.renderer.VolumeRenderer:


vapor.renderer.VolumeRenderer
-----------------------------


Help on class VolumeRenderer in vapor.renderer:

vapor.renderer.VolumeRenderer = class VolumeRenderer(Renderer)
 |  vapor.renderer.VolumeRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
