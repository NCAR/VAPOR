.. _vapor.utils.ImageRenderer:


vapor.utils.ImageRenderer
-------------------------


Help on class ImageRenderer in vapor.utils:

vapor.utils.ImageRenderer = class ImageRenderer(Renderer)
 |  vapor.utils.ImageRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
