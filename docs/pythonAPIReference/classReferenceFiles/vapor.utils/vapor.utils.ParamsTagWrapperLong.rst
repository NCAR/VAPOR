.. _vapor.utils.ParamsTagWrapperLong:


vapor.utils.ParamsTagWrapperLong
--------------------------------


Help on class ParamsTagWrapperLong in vapor.utils:

vapor.utils.ParamsTagWrapperLong = class ParamsTagWrapperLong(ParamsTagWrapper)
 |  vapor.utils.ParamsTagWrapperLong(tag: str)
 |  
