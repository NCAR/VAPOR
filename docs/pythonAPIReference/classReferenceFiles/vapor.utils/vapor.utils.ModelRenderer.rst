.. _vapor.utils.ModelRenderer:


vapor.utils.ModelRenderer
-------------------------


Help on class ModelRenderer in vapor.utils:

vapor.utils.ModelRenderer = class ModelRenderer(Renderer)
 |  vapor.utils.ModelRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
