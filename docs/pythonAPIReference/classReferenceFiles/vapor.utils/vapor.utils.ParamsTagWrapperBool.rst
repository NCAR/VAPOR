.. _vapor.utils.ParamsTagWrapperBool:


vapor.utils.ParamsTagWrapperBool
--------------------------------


Help on class ParamsTagWrapperBool in vapor.utils:

vapor.utils.ParamsTagWrapperBool = class ParamsTagWrapperBool(ParamsTagWrapper)
 |  vapor.utils.ParamsTagWrapperBool(tag: str)
 |  
