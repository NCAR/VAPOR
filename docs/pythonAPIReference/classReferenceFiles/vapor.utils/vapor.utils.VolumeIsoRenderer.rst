.. _vapor.utils.VolumeIsoRenderer:


vapor.utils.VolumeIsoRenderer
-----------------------------


Help on class VolumeIsoRenderer in vapor.utils:

vapor.utils.VolumeIsoRenderer = class VolumeIsoRenderer(VolumeRenderer)
 |  vapor.utils.VolumeIsoRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
