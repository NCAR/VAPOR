.. _vapor.utils.ContourRenderer:


vapor.utils.ContourRenderer
---------------------------


Help on class ContourRenderer in vapor.utils:

vapor.utils.ContourRenderer = class ContourRenderer(Renderer)
 |  vapor.utils.ContourRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
