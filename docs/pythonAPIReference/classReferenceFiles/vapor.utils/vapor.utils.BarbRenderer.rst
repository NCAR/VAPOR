.. _vapor.utils.BarbRenderer:


vapor.utils.BarbRenderer
------------------------


Help on class BarbRenderer in vapor.utils:

vapor.utils.BarbRenderer = class BarbRenderer(Renderer)
 |  vapor.utils.BarbRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
