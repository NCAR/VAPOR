.. _vapor.utils.Renderer:


vapor.utils.Renderer
--------------------


Help on class Renderer in vapor.utils:

vapor.utils.Renderer = class Renderer(vapor.params.ParamsWrapper)
 |  vapor.utils.Renderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
