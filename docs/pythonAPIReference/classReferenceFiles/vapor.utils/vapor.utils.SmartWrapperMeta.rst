.. _vapor.utils.SmartWrapperMeta:


vapor.utils.SmartWrapperMeta
----------------------------


Help on class SmartWrapperMeta in vapor.utils:

vapor.utils.SmartWrapperMeta = class SmartWrapperMeta(vapor.cppyyDoxygenWrapper.CPPYYDoxygenWrapperMeta)
 |  vapor.utils.SmartWrapperMeta(clsname, bases, clsdict: dict, wrap: type = None)
 |  
