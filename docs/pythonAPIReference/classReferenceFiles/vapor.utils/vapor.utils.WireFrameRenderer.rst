.. _vapor.utils.WireFrameRenderer:


vapor.utils.WireFrameRenderer
-----------------------------


Help on class WireFrameRenderer in vapor.utils:

vapor.utils.WireFrameRenderer = class WireFrameRenderer(Renderer)
 |  vapor.utils.WireFrameRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
