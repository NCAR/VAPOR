.. _vapor.utils.ParamsTagWrapperString:


vapor.utils.ParamsTagWrapperString
----------------------------------


Help on class ParamsTagWrapperString in vapor.utils:

vapor.utils.ParamsTagWrapperString = class ParamsTagWrapperString(ParamsTagWrapper)
 |  vapor.utils.ParamsTagWrapperString(tag: str)
 |  
