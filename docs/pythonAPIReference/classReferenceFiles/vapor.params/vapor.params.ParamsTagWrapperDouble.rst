.. _vapor.params.ParamsTagWrapperDouble:


vapor.params.ParamsTagWrapperDouble
-----------------------------------


Help on class ParamsTagWrapperDouble in vapor.params:

vapor.params.ParamsTagWrapperDouble = class ParamsTagWrapperDouble(ParamsTagWrapper)
 |  vapor.params.ParamsTagWrapperDouble(tag: str)
 |  
