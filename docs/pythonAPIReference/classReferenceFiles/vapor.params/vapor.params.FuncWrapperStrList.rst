.. _vapor.params.FuncWrapperStrList:


vapor.params.FuncWrapperStrList
-------------------------------


Help on class FuncWrapperStrList in vapor.params:

vapor.params.FuncWrapperStrList = class FuncWrapperStrList(FuncWrapper)
 |  vapor.params.FuncWrapperStrList(slist: str)
 |  
