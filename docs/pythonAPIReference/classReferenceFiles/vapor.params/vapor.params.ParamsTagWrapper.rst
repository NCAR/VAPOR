.. _vapor.params.ParamsTagWrapper:


vapor.params.ParamsTagWrapper
-----------------------------


Help on class ParamsTagWrapper in vapor.params:

vapor.params.ParamsTagWrapper = class ParamsTagWrapper(vapor.smartwrapper.FuncWrapper)
 |  vapor.params.ParamsTagWrapper(tag: str)
 |  
