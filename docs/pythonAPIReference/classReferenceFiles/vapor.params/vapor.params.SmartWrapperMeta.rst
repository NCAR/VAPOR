.. _vapor.params.SmartWrapperMeta:


vapor.params.SmartWrapperMeta
-----------------------------


Help on class SmartWrapperMeta in vapor.params:

vapor.params.SmartWrapperMeta = class SmartWrapperMeta(vapor.cppyyDoxygenWrapper.CPPYYDoxygenWrapperMeta)
 |  vapor.params.SmartWrapperMeta(clsname, bases, clsdict: dict, wrap: type = None)
 |  
