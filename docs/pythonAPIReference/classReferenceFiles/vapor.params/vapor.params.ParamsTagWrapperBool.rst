.. _vapor.params.ParamsTagWrapperBool:


vapor.params.ParamsTagWrapperBool
---------------------------------


Help on class ParamsTagWrapperBool in vapor.params:

vapor.params.ParamsTagWrapperBool = class ParamsTagWrapperBool(ParamsTagWrapper)
 |  vapor.params.ParamsTagWrapperBool(tag: str)
 |  
