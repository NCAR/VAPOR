.. _vapor.dataset.FlowRenderer:


vapor.dataset.FlowRenderer
--------------------------


Help on class FlowRenderer in vapor.dataset:

vapor.dataset.FlowRenderer = class FlowRenderer(Renderer)
 |  vapor.dataset.FlowRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
