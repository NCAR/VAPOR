.. _vapor.dataset.ImageRenderer:


vapor.dataset.ImageRenderer
---------------------------


Help on class ImageRenderer in vapor.dataset:

vapor.dataset.ImageRenderer = class ImageRenderer(Renderer)
 |  vapor.dataset.ImageRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
