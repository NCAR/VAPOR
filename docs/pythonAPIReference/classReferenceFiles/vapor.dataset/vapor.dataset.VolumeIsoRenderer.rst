.. _vapor.dataset.VolumeIsoRenderer:


vapor.dataset.VolumeIsoRenderer
-------------------------------


Help on class VolumeIsoRenderer in vapor.dataset:

vapor.dataset.VolumeIsoRenderer = class VolumeIsoRenderer(VolumeRenderer)
 |  vapor.dataset.VolumeIsoRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
