.. _vapor.dataset.BarbRenderer:


vapor.dataset.BarbRenderer
--------------------------


Help on class BarbRenderer in vapor.dataset:

vapor.dataset.BarbRenderer = class BarbRenderer(Renderer)
 |  vapor.dataset.BarbRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
