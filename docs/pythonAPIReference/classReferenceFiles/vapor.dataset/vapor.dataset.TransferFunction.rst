.. _vapor.dataset.TransferFunction:


vapor.dataset.TransferFunction
------------------------------


Help on class TransferFunction in vapor.dataset:

vapor.dataset.TransferFunction = class TransferFunction(vapor.params.ParamsWrapper)
 |  vapor.dataset.TransferFunction(p: cppyy.gbl.VAPoR.ParamsBase)
 |  
