.. _vapor.dataset.ContourRenderer:


vapor.dataset.ContourRenderer
-----------------------------


Help on class ContourRenderer in vapor.dataset:

vapor.dataset.ContourRenderer = class ContourRenderer(Renderer)
 |  vapor.dataset.ContourRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
