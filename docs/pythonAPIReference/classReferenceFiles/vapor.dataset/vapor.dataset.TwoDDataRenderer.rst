.. _vapor.dataset.TwoDDataRenderer:


vapor.dataset.TwoDDataRenderer
------------------------------


Help on class TwoDDataRenderer in vapor.dataset:

vapor.dataset.TwoDDataRenderer = class TwoDDataRenderer(Renderer)
 |  vapor.dataset.TwoDDataRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
