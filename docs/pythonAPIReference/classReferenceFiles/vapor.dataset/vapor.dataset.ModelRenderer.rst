.. _vapor.dataset.ModelRenderer:


vapor.dataset.ModelRenderer
---------------------------


Help on class ModelRenderer in vapor.dataset:

vapor.dataset.ModelRenderer = class ModelRenderer(Renderer)
 |  vapor.dataset.ModelRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
