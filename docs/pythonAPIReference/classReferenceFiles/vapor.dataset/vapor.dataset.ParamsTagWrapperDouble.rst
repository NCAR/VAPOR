.. _vapor.dataset.ParamsTagWrapperDouble:


vapor.dataset.ParamsTagWrapperDouble
------------------------------------


Help on class ParamsTagWrapperDouble in vapor.dataset:

vapor.dataset.ParamsTagWrapperDouble = class ParamsTagWrapperDouble(ParamsTagWrapper)
 |  vapor.dataset.ParamsTagWrapperDouble(tag: str)
 |  
