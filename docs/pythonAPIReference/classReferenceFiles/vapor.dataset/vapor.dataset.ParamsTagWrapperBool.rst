.. _vapor.dataset.ParamsTagWrapperBool:


vapor.dataset.ParamsTagWrapperBool
----------------------------------


Help on class ParamsTagWrapperBool in vapor.dataset:

vapor.dataset.ParamsTagWrapperBool = class ParamsTagWrapperBool(ParamsTagWrapper)
 |  vapor.dataset.ParamsTagWrapperBool(tag: str)
 |  
