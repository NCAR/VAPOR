.. _vapor.dataset.WireFrameRenderer:


vapor.dataset.WireFrameRenderer
-------------------------------


Help on class WireFrameRenderer in vapor.dataset:

vapor.dataset.WireFrameRenderer = class WireFrameRenderer(Renderer)
 |  vapor.dataset.WireFrameRenderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
