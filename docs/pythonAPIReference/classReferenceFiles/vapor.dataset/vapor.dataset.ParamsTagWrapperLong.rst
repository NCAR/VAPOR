.. _vapor.dataset.ParamsTagWrapperLong:


vapor.dataset.ParamsTagWrapperLong
----------------------------------


Help on class ParamsTagWrapperLong in vapor.dataset:

vapor.dataset.ParamsTagWrapperLong = class ParamsTagWrapperLong(ParamsTagWrapper)
 |  vapor.dataset.ParamsTagWrapperLong(tag: str)
 |  
