.. _vapor.dataset.Renderer:


vapor.dataset.Renderer
----------------------


Help on class Renderer in vapor.dataset:

vapor.dataset.Renderer = class Renderer(vapor.params.ParamsWrapper)
 |  vapor.dataset.Renderer(renderParams: cppyy.gbl.VAPoR.RenderParams, id: str)
 |  
