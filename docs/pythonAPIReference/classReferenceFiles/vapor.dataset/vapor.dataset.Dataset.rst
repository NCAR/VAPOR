.. _vapor.dataset.Dataset:


vapor.dataset.Dataset
---------------------


Help on class Dataset in vapor.dataset:

vapor.dataset.Dataset = class Dataset(vapor.smartwrapper.SmartWrapper)
 |  vapor.dataset.Dataset(dataMgr: cppyy.gbl.VAPoR.DataMgr, id: str, ses)
 |  
 |  Wraps VAPoR::DataMgr
