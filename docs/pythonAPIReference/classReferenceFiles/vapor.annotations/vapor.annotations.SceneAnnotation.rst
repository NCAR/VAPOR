.. _vapor.annotations.SceneAnnotation:


vapor.annotations.SceneAnnotation
---------------------------------


Help on class SceneAnnotation in vapor.annotations:

vapor.annotations.SceneAnnotation = class SceneAnnotation(vapor.params.ParamsWrapper)
 |  vapor.annotations.SceneAnnotation(p: cppyy.gbl.VAPoR.ParamsBase)
 |  
