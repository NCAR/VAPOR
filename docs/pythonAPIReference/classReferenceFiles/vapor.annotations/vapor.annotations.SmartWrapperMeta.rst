.. _vapor.annotations.SmartWrapperMeta:


vapor.annotations.SmartWrapperMeta
----------------------------------


Help on class SmartWrapperMeta in vapor.annotations:

vapor.annotations.SmartWrapperMeta = class SmartWrapperMeta(vapor.cppyyDoxygenWrapper.CPPYYDoxygenWrapperMeta)
 |  vapor.annotations.SmartWrapperMeta(clsname, bases, clsdict: dict, wrap: type = None)
 |  
