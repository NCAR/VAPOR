.. _vapor.annotations.ParamsWrapper:


vapor.annotations.ParamsWrapper
-------------------------------


Help on class ParamsWrapper in vapor.annotations:

vapor.annotations.ParamsWrapper = class ParamsWrapper(vapor.smartwrapper.SmartWrapper)
 |  vapor.annotations.ParamsWrapper(p: cppyy.gbl.VAPoR.ParamsBase)
 |  
