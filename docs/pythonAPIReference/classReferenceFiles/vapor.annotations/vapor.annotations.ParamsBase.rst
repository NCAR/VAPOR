.. _vapor.annotations.ParamsBase:


vapor.annotations.ParamsBase
----------------------------


Help on class ParamsBase in vapor.annotations:

vapor.annotations.ParamsBase = class ParamsBase(cppyy.gbl.Wasp.MyBase)
