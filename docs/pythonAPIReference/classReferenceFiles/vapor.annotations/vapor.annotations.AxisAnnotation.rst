.. _vapor.annotations.AxisAnnotation:


vapor.annotations.AxisAnnotation
--------------------------------


Help on class AxisAnnotation in vapor.annotations:

vapor.annotations.AxisAnnotation = class AxisAnnotation(vapor.params.ParamsWrapper)
 |  vapor.annotations.AxisAnnotation(p: cppyy.gbl.VAPoR.ParamsBase)
 |  
