.. _vapor.annotations.ParamsTagWrapperDouble:


vapor.annotations.ParamsTagWrapperDouble
----------------------------------------


Help on class ParamsTagWrapperDouble in vapor.annotations:

vapor.annotations.ParamsTagWrapperDouble = class ParamsTagWrapperDouble(ParamsTagWrapper)
 |  vapor.annotations.ParamsTagWrapperDouble(tag: str)
 |  
