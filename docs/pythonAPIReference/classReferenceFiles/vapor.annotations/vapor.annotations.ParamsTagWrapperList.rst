.. _vapor.annotations.ParamsTagWrapperList:


vapor.annotations.ParamsTagWrapperList
--------------------------------------


Help on class ParamsTagWrapperList in vapor.annotations:

vapor.annotations.ParamsTagWrapperList = class ParamsTagWrapperList(vapor.smartwrapper.FuncWrapper)
 |  vapor.annotations.ParamsTagWrapperList(slist: str)
 |  
