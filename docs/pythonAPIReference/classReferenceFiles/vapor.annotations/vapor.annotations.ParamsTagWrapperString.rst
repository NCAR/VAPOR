.. _vapor.annotations.ParamsTagWrapperString:


vapor.annotations.ParamsTagWrapperString
----------------------------------------


Help on class ParamsTagWrapperString in vapor.annotations:

vapor.annotations.ParamsTagWrapperString = class ParamsTagWrapperString(ParamsTagWrapper)
 |  vapor.annotations.ParamsTagWrapperString(tag: str)
 |  
