.. _vapor.annotations.EnumWrapperMeta:


vapor.annotations.EnumWrapperMeta
---------------------------------


Help on class EnumWrapperMeta in vapor.annotations:

vapor.annotations.EnumWrapperMeta = class EnumWrapperMeta(builtins.type)
