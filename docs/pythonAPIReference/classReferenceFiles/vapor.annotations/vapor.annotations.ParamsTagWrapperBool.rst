.. _vapor.annotations.ParamsTagWrapperBool:


vapor.annotations.ParamsTagWrapperBool
--------------------------------------


Help on class ParamsTagWrapperBool in vapor.annotations:

vapor.annotations.ParamsTagWrapperBool = class ParamsTagWrapperBool(ParamsTagWrapper)
 |  vapor.annotations.ParamsTagWrapperBool(tag: str)
 |  
