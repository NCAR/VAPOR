...
Here we demonstrate how to use *xarray* to apply the CF Conventions to a basic NetCDF file (`simple.nc <https://drive.google.com/file/d/18CFrtFxvHwfL30Xd91TNU38J_z-Kgywm/view?usp=sharing>`_) to define it on a regular, rectilinar grid for ingesting into Vapor.  You can download this Python script ***NEED LINK*** that replicates the steps below.
...
.. jupyter-execute::
  ...
  ds.to_netcdf("/Users/pearse/CFConventions/data/regularCompliant.nc")
