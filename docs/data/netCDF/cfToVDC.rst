...
The two tools for converting :ref:`CF-Compliant <cfCompliance>` NetCDF into VDC are ``cfvdccreate`` and ``cf2vdc``.  Advanced options can be seen at the bottom of this page, or by issuing the commands
