...
: PWidget("", _group = new VSectionGroup("Transform"))
{
...
void PTransformWidget::translateChanged(const std::vector<double> xyz)
{
    getParams<Transform>()->SetTranslations(xyz);
}

void PTransformWidget::scaleChanged(const std::vector<double> xyz)
{
    getParams<Transform>()->SetScales(xyz);
}

void PTransformWidget::originChanged(const std::vector<double> xyz)
{
    getParams<Transform>()->SetOrigin(xyz);
}



PRendererTransformWidget::PRendererTransformWidget()
: PWidget("", _widget = new PTransformWidget) {}
