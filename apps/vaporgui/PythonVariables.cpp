...
void PythonVariables::_connectWidgets() {
    connect(_newButton, SIGNAL(clicked()),
            this, SLOT(_newScript()));
    connect(_saveCombo, SIGNAL(currentIndexChanged(int)),
...
void NewItemDialog::_connectWidgets() {
    ...
    connect(_cancelButton, SIGNAL(clicked()),
            this, SLOT(reject()));
    connect(_optionNameCombo, SIGNAL(currentIndexChanged(int)),
            this, SLOT(_dataMgrChanged(int)));
    connect(_itemNameEdit, SIGNAL(textChanged(const QString &)),
            this, SLOT(_itemNameChanged(const QString &)));
}
