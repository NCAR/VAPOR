...
class PScalarVariableSelectorHLI : public PScalarVariableSelector,
  ...
  public:
    PScalarVariableSelectorHLI() : PScalarVariableSelector(),
...
class PScalarVariableSelector2DHLI : public PVariableSelector2D,
                                     public PWidgetHLIBase<VAPoR::RenderParams, std::string> {
  public:
    PScalarVariableSelector2DHLI() : PVariableSelector2D("", "Variable Name"),
                                     PWidgetHLIBase<VAPoR::RenderParams, std::string>(
                                         (PWidget *)this,
                                         &VAPoR::RenderParams::GetVariableName,
                                         &VAPoR::RenderParams::SetVariableName) {}
...
class PScalarVariableSelector3DHLI :
    ...
    public PWidgetHLIBase<VAPoR::RenderParams, std::string> {
  public:
    PScalarVariableSelector3DHLI() : PVariableSelector3D("", "Variable Name"),
                                     PWidgetHLIBase<VAPoR::RenderParams, std::string>(
                                         (PWidget *)this,
                                         &VAPoR::RenderParams::GetVariableName,
                                         &VAPoR::RenderParams::SetVariableName) {}
...
class PColorMapVariableSelectorHLI : public PColorMapVariableSelector,
                                     public PWidgetHLIBase<VAPoR::RenderParams, std::string> {
  public:
    PColorMapVariableSelectorHLI() : PColorMapVariableSelector(),
                                     PWidgetHLIBase<VAPoR::RenderParams, std::string>(
                                         (PWidget *)this,
...
class PHeightVariableSelectorHLI : public PHeightVariableSelector,
                                   public PWidgetHLIBase<VAPoR::RenderParams, std::string> {
  public:
    PHeightVariableSelectorHLI() : PHeightVariableSelector(),
                                   PWidgetHLIBase<VAPoR::RenderParams, std::string>(
                                       (PWidget *)this,
...
class PXFieldVariableSelectorHLI : public PXFieldVariableSelector,
                                   public PWidgetHLIBase<VAPoR::RenderParams, std::string> {
  public:
    PXFieldVariableSelectorHLI() : PXFieldVariableSelector(),
                                   PWidgetHLIBase<VAPoR::RenderParams, std::string>(
                                       (PWidget *)this,
...
class PYFieldVariableSelectorHLI : public PYFieldVariableSelector,
                                   public PWidgetHLIBase<VAPoR::RenderParams, std::string> {
  public:
    PYFieldVariableSelectorHLI() : PYFieldVariableSelector(),
                                   PWidgetHLIBase<VAPoR::RenderParams, std::string>(
                                       (PWidget *)this,
...
class PZFieldVariableSelectorHLI : public PZFieldVariableSelector,
                                   public PWidgetHLIBase<VAPoR::RenderParams, std::string> {
  public:
    PZFieldVariableSelectorHLI() : PZFieldVariableSelector(),
                                   PWidgetHLIBase<VAPoR::RenderParams, std::string>(
                                       (PWidget *)this,
