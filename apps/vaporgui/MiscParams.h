...
public:
    ...
    //
    void SetTimeStep(bool val) { SetValueLong(_timeStepTag, "Set use of time step banner", (long)val); }
    ...
    //
    void SetTimeStamp(bool val) { SetValueLong(_timeStampTag, "Set use of time step string banner", (long)val); }
    ...
    void SetTimeAnnotLLX(float llx) { SetValueLong(_timeAnnotLLXTag, "Set the lower-left coord of the time annotation", (long)llx); }

    float GetTimeAnnotLLX() const { return (float)GetValueLong(_timeAnnotLLXTag, 10); }

    void SetTimeAnnotLLY(float lly) { SetValueLong(_timeAnnotLLYTag, "Set the lower-right coord of the time annotation", (long)lly); }

    float GetTimeAnnotLLY() const { return (float)GetValueLong(_timeAnnotLLYTag, 10); }

    void SetTimeAnnotSize(float size) { SetValueLong(_timeAnnotSizeTag, "Set the text size of the time annotation", (long)size); }
