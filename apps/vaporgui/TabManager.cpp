...
TabManager::TabManager(QWidget *parent, ControlExec *ce) : QTabWidget(parent)
{
    ...
    connect(_renderHolder, SIGNAL(newRenderer(string, string, string)), this, SLOT(newRenderer(string, string, string)));
...
void TabManager::setActive(string activeViz, string renderClass, string renderInst)
{
    ...
    RenderEventRouter *eRouter = VizWinMgr::getInstance()->GetRenderEventRouter(activeViz, renderClass, renderInst);
...
void TabManager::newRenderer(string activeViz, string renderClass, string renderInst)
{
    ...
    RenderEventRouter *er = VizWinMgr::getInstance()->GetRenderEventRouter(activeViz, renderClass, renderInst);
