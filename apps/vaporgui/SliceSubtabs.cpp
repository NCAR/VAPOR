...
SliceAppearanceSubtab::SliceAppearanceSubtab(QWidget *parent) {
    ...
    connect(_xSamplingRate, SIGNAL(valueChanged(int)), this,
            SLOT(xSamplingRateChanged(int)));
    connect(_ySamplingRate, SIGNAL(valueChanged(int)), this,
            SLOT(ySamplingRateChanged(int)));
    connect(_zSamplingRate, SIGNAL(valueChanged(int)), this,
            SLOT(zSamplingRateChanged(int)));
}
