...
BarbEventRouter::BarbEventRouter(QWidget *parent, ControlExec *ce) : RenderEventRouterGUI(ce, BarbParams::GetClassType())
{
    ...
    AddSubtab("Appearance",
              new PGroup({new PSection("Barbs", {(new PIntegerSliderEdit(BP::_xBarbsCountTag, "X Barbs"))->SetRange(1, 50), (new PIntegerSliderEdit(BP::_yBarbsCountTag, "Y Barbs"))->SetRange(1, 50),
                                                 ...
                                                 new PCheckbox(BP::_useSingleColorTag, "Use Constant Color"), new PColorSelector(BP::_constantColorTag, "Constant Color")}),
