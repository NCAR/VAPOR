    ...
    _seedingTab =
        AddSubtab("Seeding", new PGroup({
                                 ...
                                 new PSection("Seed Distribution Settings", {
                                                                                ...
                                                                                (new PShowIf(FP::_seedGenModeTag))->Equals((int)FlowSeedMode::RANDOM_BIAS)->Then({(new PIntegerSliderEdit(FP::_randomNumOfSeedsTag, "Seed count"))->SetRange(1, 500), (new PDoubleSliderEdit(FP::_rakeBiasStrength, "Bias weight"))->SetRange(-10, 10), new PVariableSelector(FP::_rakeBiasVariable)}),
                                 ...
                                 new PSection("Write Flowlines to File", {new PFileOpenSelector(FP::_flowlineOutputFilenameTag, "Target file"), new PButton("Write to file", [](ParamsBase *p) { p->SetValueLong(FP::_needFlowlineOutputTag, "", true); })}),
                             }));
