...
PStringInput::PStringInput(const std::string &tag, const std::string &label)
    : PLineItem(tag, label, _stringLineEdit = new VStringLineEdit) {
...
void PStringInput::inputValueChanged(const std::string &v) {
    setParamsString(v);
}
