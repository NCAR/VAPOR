...
void
FileOperationChecker::PopWarning( const QString& errorMessage )
{
    QMessageBox msgBox; 
...
bool 
FileOperationChecker::DirectoryGoodToRead( const QString& filename )
{
...
bool 
FileOperationChecker::FileGoodToRead( const QString& filename )
{
    QFileInfo fileInfo( filename );
...
bool 
FileOperationChecker::FileGoodToWrite( const QString& filename )
{
    QFileInfo fileInfo( filename );
