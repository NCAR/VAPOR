...
QSinglePoint::QSinglePoint(QWidget *parent) : QWidget(parent),
    ...
    connect(_ui->_xSliderEdit, SIGNAL(valueChanged(double)),
            this, SLOT(_coordinateChanged(double)));
    connect(_ui->_ySliderEdit, SIGNAL(valueChanged(double)),
            this, SLOT(_coordinateChanged(double)));
    connect(_ui->_zSliderEdit, SIGNAL(valueChanged(double)),
            this, SLOT(_coordinateChanged(double)));
    connect(_ui->_tSliderEdit, SIGNAL(valueChanged(double)),
            this, SLOT(_coordinateChanged(double)));
