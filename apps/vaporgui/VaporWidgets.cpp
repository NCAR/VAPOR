...
VSpinBox::VSpinBox(
    ...
    int defaultValue) : VaporWidget(parent, labelText),
                        _value(defaultValue) {
...
VDoubleSpinBox::VDoubleSpinBox(
    QWidget *parent,
    const std::string &labelText,
    double defaultValue) : VaporWidget(parent, labelText),
                           _value(defaultValue) {
...
float VSlider::GetCurrentValue() const {
    return _currentVal;
}
...
int VIntSlider::GetCurrentValue() const {
...
void VGeometry::_respondChanges() {
...
VLineEdit::VLineEdit(
    QWidget *parent,
    const std::string &labelText,
    const std::string &editText) : VaporWidget(parent, labelText) {
    _text = editText;
...
VComboBox::VComboBox(
    QWidget *parent,
    const std::string &labelText) : VaporWidget(parent, labelText) {
...
VFileSelector::VFileSelector(
    ...
    QFileDialog::FileMode fileMode) : VPushButton(parent, labelText, buttonText),
                                      _filePath(filePath) {
...
VFileReader::VFileReader(
    ...
    const std::string &labelText,
    const std::string &buttonText,
    const std::string &filePath) : VFileSelector(parent,
                                                 labelText,
                                                 buttonText,
                                                 filePath,
