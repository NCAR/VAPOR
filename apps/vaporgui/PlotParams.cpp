...
std::vector<double> PlotParams::GetMinExtents() const {
    return GetValueDoubleVec(_minExtentTag);
}
...
std::vector<double> PlotParams::GetMaxExtents() const {
    return GetValueDoubleVec(_maxExtentTag);
}
