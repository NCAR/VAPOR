...
VolumeIsoEventRouter::VolumeIsoEventRouter(QWidget *parent, ControlExec *ce)
    ...
    AddSubtab("Appearance", new PGroup({new PTFEditor(RenderParams::_variableNameTag, {PTFEditor::Histogram, PTFEditor::IsoValues}),
                                        ...
                                        (new PShowIf(VIP::_algorithmTag))->Equals(VolumeOSPRayIso::GetName())->Then({new PSection("OSPRay Parameters", {
