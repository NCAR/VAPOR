...
VolumeIsoEventRouter::VolumeIsoEventRouter(QWidget *parent, ControlExec *ce) : RenderEventRouterGUI(ce, VolumeIsoParams::GetClassType())
{
    ...
    AddSubtab("Appearance",
              new PGroup({new PTFEditor(RenderParams::_variableNameTag, {PTFEditor::Histogram, PTFEditor::IsoValues}),
                          new PSection("Ray Tracing", {new PStringDropdownHLI<VIP>("Raytracing Algorithm", VIP::GetAlgorithmNames(VIP::Type::Iso), &VIP::GetAlgorithm, &VIP::SetAlgorithmByUser),
