...
class GUIStateParams : public VAPoR::ParamsBase {
  ...
  public:
    ...
    std::vector<string> GetOpenDataSetNames() const {
        return (m_openDataSets->GetNames());
    }
    ...
    void InsertOpenDateSet(
        string dataSetName, string format, const std::vector<string> &paths);
    ...
    class DataSetParam : public ParamsBase {
      public:
        DataSetParam(
            VAPoR::ParamsBase::StateSave *ssave) : ParamsBase(ssave, DataSetParam::GetClassType()) {}

        DataSetParam(
            VAPoR::ParamsBase::StateSave *ssave, VAPoR::XmlNode *node) : ParamsBase(ssave, node) {}
        ...
        string GetFormat() const {
            return (GetValueString(m_dataSetFormatTag, "vdc"));
        }
  ...
  private:
    class ActiveRenderer : public ParamsBase {
      public:
        ActiveRenderer(
            VAPoR::ParamsBase::StateSave *ssave) : ParamsBase(ssave, ActiveRenderer::GetClassType()) {}
