...
def transferFunctionWidget(ses, ren, nControlPoints=5):
        ...
        hist_values = (hist_values / max(hist_values)) * 100 # Scale so y-axis is between 0 and 100
        ...
        ren.GetPrimaryTransferFunction().SetOpacityControlPoints([[x, y/100] for x, y in init_points])
        ...
        def on_drag(change):
            ...
            ren.GetPrimaryTransferFunction().SetOpacityControlPoints([[x, y/100] for x, y in control_points])
        ...
        def update_histogram_range(change):
            ...
            ren.GetPrimaryTransferFunction().SetOpacityControlPoints([[x, y/100] for x, y in new_cp])
