...
class Log {
    ...
    static void print(String fmt, Args... args)
    {
        fmt += "\n";
...
public:
    ...
    template<typename... Args>
    static void Fatal(const String &fmt, Args... args)
    {
        print(fmt, args...);
        fatal();
    }
    ...
    template<typename... Args>
    static void Message(const String &fmt, Args... args)
    {
        print(fmt, args...);
    }
    ...
    template<typename... Args>
    static void Warning(const String &fmt, Args... args)
    {
        print(fmt, args...);
    }
};
...
#define LogWarning(fmt, ...) _Log(Info, fmt, ##__VA_ARGS__)
