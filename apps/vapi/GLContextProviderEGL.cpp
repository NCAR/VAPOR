...
GLContextProviderEGL::GLContextEGL::GLContextEGL(void *display, void *surface, void *context)
: _display(display), _surface(surface), _context(context) {}

GLContextProviderEGL::GLContextEGL::~GLContextEGL()
{
    eglTerminate(_display);
}

void GLContextProviderEGL::GLContextEGL::MakeCurrent()
{
