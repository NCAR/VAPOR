...
public:
    ...
    void SetLocalExtents(const vector<double> &minExt, const vector<double> &maxExt, int timestep = -1)
    {
...
private:
    ...
    void convertThetaPhiPsi(double *newTheta, double *newPhi, double *newPsi, int axis, double rotation) const;

    // Not part of public API
    void calcLocalBoxCorners(double corners[8][3], float extraThickness, int timestep, double rotation = 0., int axis = -1) const;
