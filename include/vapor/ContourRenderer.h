...
#ifdef DEAD
    static Renderer *CreateInstance(Visualizer *v, RenderParams *rp, ShaderMgr *sm) { return new ContourRenderer(v, rp, sm); }
#endif
...
private:
    ...
    bool pointWithinBounds(double x, double y, double z, vector<double> varMin, vector<double> varMax);
