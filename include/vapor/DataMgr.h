  ...
  private:
    ...
    class VarInfoCache {
      public:
        ...
        bool Get(
            string hash, std::vector<void *> &values) const {
            values.clear();
    ...
    bool _hasVerticalXForm(
        string meshname, string &standard_name, string &formula_terms) const;
