...
public:
    ...
    //
    CurvilinearGrid(const size_t bs[3], const size_t min[3], const size_t max[3], const bool periodic[3], const std::vector<float *> &blks, const RegularGrid &xrg, const RegularGrid &yrg,
    ...
    //! \sa RegularGrid()
    //
    CurvilinearGrid(const std::vector<size_t> &bs, const std::vector<size_t> &min, const std::vector<size_t> &max, const std::vector<bool> &periodic, const std::vector<float *> &blks,
                    const RegularGrid &xrg, const RegularGrid &yrg, const std::vector<double> &zcoords, const KDTreeRGSubset &kdtree);
    ...
    //
    CurvilinearGrid(const size_t bs[3], const size_t min[3], const size_t max[3], const bool periodic[3], const std::vector<float *> &blks, const RegularGrid &xrg, const RegularGrid &yrg,
                    const std::vector<double> &zcoords, const KDTreeRGSubset &kdtree, float missing_value);
    ...
    //
    CurvilinearGrid(const std::vector<size_t> &bs, const std::vector<size_t> &min, const std::vector<size_t> &max, const std::vector<bool> &periodic, const std::vector<float *> &blks,
                    const RegularGrid &xrg, const RegularGrid &yrg, const std::vector<double> &zcoords, const KDTreeRGSubset &kdtree, float missing_value);
...
private:
    ...
    void _curvilinearGrid(const RegularGrid &xrg, const RegularGrid &yrg, const std::vector<double> &zcoords, const KDTreeRGSubset &kdtree);
    ...
    bool _insideGrid(double x, double y, double z, int &i, int &j, int &k, double lambda[4], double zwgt[2]) const;
