...
class VDF_API NetCDFSimple : public Wasp::MyBase {
  public:
    ...
    //!
    int Read(
        const size_t start[], const size_t count[], float *data, int fd = 0) const;
    int Read(
        const size_t start[], const size_t count[], int *data, int fd = 0) const;
    int Read(
        const size_t start[], const size_t count[], char *data, int fd = 0) const;
