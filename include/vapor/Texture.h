...
namespace VAPoR {
    ...
    class Texture1D : public Texture { public: Texture1D(); };
    class Texture2D : public Texture { public: Texture2D(); void CopyDepthBuffer(); };
    class Texture3D : public Texture { public: Texture3D(); };
    class Texture2DArray : public Texture { public: Texture2DArray(); };
};
