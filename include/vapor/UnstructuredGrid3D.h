...
// }
 ...
 public:
  ...
  virtual bool equal(const void* rhs) const override {
	const ConstCoordItrU3D *itrptr = 
		static_cast<const ConstCoordItrU3D *> (rhs);
  ...
  virtual std::unique_ptr<ConstCoordItrAbstract> clone() const override {
	return std::unique_ptr<ConstCoordItrAbstract> (new ConstCoordItrU3D(*this));
  };
 ...
 virtual ConstCoordItr ConstCoordBegin() const override {
	return ConstCoordItr (
		std::unique_ptr<ConstCoordItrAbstract> (new ConstCoordItrU3D(this, true))
	);
 }
 virtual ConstCoordItr ConstCoordEnd() const override {
	return ConstCoordItr (
		std::unique_ptr<ConstCoordItrAbstract> (new ConstCoordItrU3D(this, false))
	);
 }
