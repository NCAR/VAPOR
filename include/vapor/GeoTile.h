...
class RENDER_API GeoTile {
  ...
  public:
    ...
    virtual void LatLongToPixelXY(
        double lon, double lat, int lod, size_t &pixelX, size_t &pixelY) const = 0;
    ...
    virtual void PixelXYToLatLon(
        size_t pixelX, size_t pixelY, int lod, double &lon, double &lat) const = 0;
    ...
    void PixelXYToTileXY(
        ...
        size_t &tileX, size_t &tileY, size_t &tilePixelX, size_t &tilePixelY) const;
    ...
    void TileXYToPixelXY(
        size_t tileX, size_t tileY, size_t &pixelX, size_t &pixelY) const;
    ...
    int MapSize(
        size_t pixelX0, size_t pixelY0, size_t pixelX1, size_t pixelY1,
        int lod, size_t &nx, size_t &ny) const;

    void GetLatLonExtents(
        double &minlon, double &minlat, double &maxlon, double &maxlat) const {
    ...
    void LatLongRectToPixelRect(
        const double geoSW[2], const double geoNE[2], int lod, size_t pixelSW[2], size_t pixelNE[2]) const;
  ...
  private:
    ...
    void _CopyTileToMap(
        ...
        unsigned char *map, size_t pixelX0, size_t pixelX1, size_t nx, size_t ny) const;
