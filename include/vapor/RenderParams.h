...
public:
    ...
    virtual MapperFunction *GetMapperFunc(string varname) const { return (RenderParams::GetTransferFunc(varname)); }
    ...
    virtual MapperFunction *MakeMapperFunc(string varname) { return (RenderParams::MakeTransferFunc(varname)); }
    ...
    void SetUseSingleColor(bool val) { SetValueLong(_useSingleColorTag, "enable/disable use single color", (long)val); }
