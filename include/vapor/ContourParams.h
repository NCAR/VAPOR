...
public:
    ...
    void SetContourSpacing(double val) { SetValueDouble(_contourSpacingTag, "Spacing between contours", val); }
    ...
    void SetIsovalues(vector<double> vals) { SetValueDoubleVec(_contoursTag, "Isovalue list", vals); }
