...
public:
    ...
    void SetTexSizeEnable(bool val) { SetValueLong(_texSizeEnableTag, "toggle enable texture size", (long)val); }
    ...
    void SetWinSizeLock(bool val) { SetValueLong(_winSizeLockTag, "toggle lock window size", (long)val); }
    ...
    void SetSessionDir(string name) { SetValueString(_sessionDirTag, "set session directory", name); }

    string GetMetadataDir() const { return GetValueString(_metadataDirTag, string(".")); }

    void SetMetadataDir(string dir) { SetValueString(_metadataDirTag, "set metadata directory", dir); }
    ...
    void SetNumExecutionThreads(size_t val) { SetValueLong(_numExecutionThreads, "Number of execution threads", 0); }
