...
public:
	...
	void setBypass(int timestep) {if(_currentRenderParams)_currentRenderParams->setBypass(timestep);}
	...
	void setPartialBypass(int timestep) {if(_currentRenderParams)_currentRenderParams->setPartialBypass(timestep);}
	...
	void setAllBypass(bool val){if (_currentRenderParams) _currentRenderParams->setAllBypass(val);}
...
template<class T>
class RENDER_API RendererRegistrar {
public:
