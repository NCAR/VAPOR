...
public:
    ...
    //! \copydoc DC::GetVar()
    //!
    virtual int GetVar(string varname, int, int, float *data) { return (DCWRF::GetVar(varname, data)); }
    ...
    //! \copydoc DC::GetVar()
    //!
    virtual int GetVar(size_t ts, string varname, int, int, float *data) { return (DCWRF::GetVar(ts, varname, data)); }
...
private:
    ...
    public:
        DerivedVarElevation(NetCDFCollection *ncdfc, string name, const vector<DC::Dimension> &dims, float grav);
    ...
    public:
        DerivedVarTime(NetCDFCollection *ncdfc, DC::Dimension dims, const std::vector<float> &timecoords);
