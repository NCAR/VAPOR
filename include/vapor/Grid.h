...
class VDF_API Grid {
  public:
    ...
    //
    virtual void GetUserExtents(
        double minu[3], double maxu[3]) const {
    ...
    virtual void GetBoundingBox(
        ...
        DblArr3 &minu, DblArr3 &maxu) const = 0;
    ...
    virtual bool GetEnclosingRegion(
        ...
        Size_tArr3 &min, Size_tArr3 &max) const = 0;
    ...
    virtual bool GetCellNodes(
        ...
        std::vector<Size_tArr3> &nodes) const = 0;
    ...
    virtual bool GetCellNeighbors(
        const Size_tArr3 &cindices,
        std::vector<Size_tArr3> &cells) const = 0;
  ...
  protected:
    ...
    virtual float *GetValuePtrAtIndex(
        const std::vector<float *> &blks, const Size_tArr3 &indices) const;
